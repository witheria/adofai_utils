...
class CoordinatePlotter(tk.Tk):
    """
    This class is used to plot an adofai map (pretty badly) in tkinter. One can zoom and drag the map.

    However, somehow this is still prone to crashing. I'm not planning on fixing this.
    """
    tile_list: list[Tile]
    scale: float
